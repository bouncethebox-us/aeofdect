#This script requires the enterprise application deployed
...
#export
$UnifiedGroupDataCollection | Export-csv c:\temp\M365GroupUsageReport.csv -NoTypeInformation -Encoding utf8
...
write-host -ForegroundColor Yellow "Saved output to C:\temp\wmata-discovery\m365groupgsagereport.csv"
