...
<#
	  ...
	  .EXAMPLE
	  	.\CreateAppRegistration_PlanetReporting.ps1
	  .EXAMPLE
	  	.\CreateAppRegistration_PlanetReporting.ps1 -GCCH
	  .PARAMETER GCCH
	  	Switch parameter to specify if the tenant is GCCH. Excluding this the tenant is assumed to be Commercial, EDU, GCC
	  .Link
		https://goplanet.sharepoint.com/sites/PlanetEastCollaboration-CollabDelivery/SitePages/Script_CreateAppRegistration_PlanetReporting.aspx
#>
...
$ErrorCount = 0 
$AppRegistrationName = 'Planet_Reporting'
