...
<#
	...
	.PARAMETER SPAdminCenterURL
	  	Full Url to the tenant SharePoint administration site Example: https://planetdemolab-admin.sharepoint.com
	.Link
		https://goplanet.sharepoint.com/sites/EastCoastSharePoint-Delivery/SitePages/GetAllSites.aspx
...
[CmdletBinding()]
	Param(
		...
		$DataCollection | Export-csv "C:\temp\wmata-discovery\spositessource.csv" -notypeinformation
...
write-host -ForegroundColor Yellow "Saved output to C:\temp\wmata-discovery\spositessource.csv"
